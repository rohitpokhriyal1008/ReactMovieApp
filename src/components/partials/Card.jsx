    ...
    <div className='w-full h-full  p-[3%] flex flex-wrap gap-10'>    
        {data.map((item,index) => (
            ...
            <h1 className='text-2xl my-2 text-zinc-300 px-2 font-semibold'>
                ...
                {item.vote_average && <div className='flex justify-center items-center absolute right-[-10%] bottom-[15%] w-[4vw] h-[7vh] font-bold text-zinc-800 rounded-[50%] bg-yellow-400'>
