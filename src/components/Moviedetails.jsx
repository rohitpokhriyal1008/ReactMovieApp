  ...
  return info ? ( 
    ...
    className='h-full w-screen  px-[3%] bg-blue-200'>
      ...
      <p className='mt-5 lg:mt-10 w-[90%] text-xm lg:text-xl tracking-wide text-zinc-300 '>{info.detail.overview}</p>
       <div className='mt-24 lg:mt-10 mb-12 text-[1rem] lg:text-2xl flex items-center gap-x-6 lg:gap-x-20 text-zinc-300 font-extrabold tracking-wider'>
       <h1 className='flex justify-center items-center w-[15vw] h-[6vh]  lg:w-[4vw] lg:h-[7vh] font-bold text-zinc-800 rounded-[50%] bg-yellow-400'>
          {(info.detail.vote_average*10).toFixed()} <sup>%</sup>
       </h1>
       <h1 className='text-xm lg:text-xl '>{info.detail.runtime} min</h1>
