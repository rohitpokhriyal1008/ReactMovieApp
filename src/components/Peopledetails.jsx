...
const Peopledetails = () => {
        ...
        return info ? (
          <div className='w-full h-full bg-[#1F1E24] p-[3%]'>
             ...
             <div className=' w-full lg:px-[5%] lg:flex gap-x-[4%]'>
              {/* left part start */}
              <div className='left-part w-full lg:w-[25%] h-full'>
              <img className='h-full w-full object-cover rounded-md ' src={`https://image.tmdb.org/t/p/original/${info.detail.profile_path}`} alt="" />
              <hr className='my-8' />
              <h1 className='lg:hidden text-5xl font-extrabold my-7 mb-12 text-center '>{info.detail.name}</h1>

       <a target="_blank" href={`https://www.wikidata.org/wiki/${info.externalid.wikidata_id}`}><i title="wikidata" className="ml-12 lg:ml-4 hover:text-blue-800 text-3xl lg:text-2xl ri-dribbble-fill"></i></a>
       <a target="_blank" href={`https://www.facebook.com/${info.externalid.facebook_id}`}><i title="facebook" className="ml-12 hover:text-blue-800 text-3xl lg:text-2xl ri-facebook-circle-fill"></i></a>
       <a target="_blank" href={`https://www.instagram.com/${info.externalid.instagram_id}`}><i title="instagram" className="ml-12  hover:text-blue-800 text-3xl lg:text-2xl ri-instagram-fill"></i></a>
       <a target="_blank" href={`https://www.twitter.com/${info.externalid.twitter_id}`}><i title="twitter" className="ml-12  hover:text-blue-800 text-3xl lg:text-2xl ri-twitter-x-fill"></i></a>
          <div className='text-zinc-300 my-10 lg:my-5 flex flex-col'>
          <h1 className='text-2xl mb-3'>Personal Information</h1>
           <h2 className='text-xl'>Known for </h2>
             ...
             <h3>{info.detail.also_known_as.join(" , ")}</h3>
              ...
              {/* right part start */}
              <div className='right-part h-full w-full lg:w-[79%] '>
                 <h1 className='text-5xl font-extrabold my-7 lg:block hidden '>{info.detail.name}</h1>
                 ...
                 <div className='w-full mt-12 lg:mt-6 overflow-y-auto border border-zinc-300 h-[60vh] shadow-lg shadow-[rgba(255,255,255,.7)] p-[2%]'>
